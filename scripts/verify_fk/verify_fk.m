...
toolbox_src = '/Users/markusgambietz/PhD/00_MatLab_Projects/BioMAC-Sim-Toolbox/src';
addpath(genpath(toolbox_src));

osim_path = '/Users/markusgambietz/PhD/01_Python_Projects/biomechpriorVAE/plot/skeleton_frames/model/sipp_generic_runmad_smoothsphere.osim';
...
data = load('/Users/markusgambietz/PhD/01_Python_Projects/biomechpriorVAE/scripts/verify_fk/q_row3_k22.mat');
q_py = data.q(:);
...
out_path = '/Users/markusgambietz/PhD/01_Python_Projects/biomechpriorVAE/scripts/verify_fk/fk_result.mat';
